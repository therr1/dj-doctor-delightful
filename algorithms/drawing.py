...
class Example(QtGui.QWidget):
    ...
    def initUI(self):      
        self.text = "blah"
        self.setGeometry(100, 100, LENGTH*STRIDE_LENGTH+20, HEIGHT*STRIDE_LENGTH+50)
    ...
    def drawRects(self, colors):
        for i in range(len(self.locations)):
            ...
            self.qp.setBrush(QtGui.QColor(rgbtuple[0],rgbtuple[1],rgbtuple[2]))
            self.qp.drawRect(self.locations[i][1]*STRIDE_LENGTH+10, self.locations[i][0]*STRIDE_LENGTH+10, 5, 5)
